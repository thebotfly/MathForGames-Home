...
namespace UnitTestProject
{
    ...
    public class UnitTest1
    {
        ...
        {
            _ = new Matrix4();
            Matrix4 m4a = Matrix4.CreateRotationX(4.5f);
        ...
        {
            _ = new Matrix4();
            Matrix4 m4b = Matrix4.CreateRotationY(-2.6f);
        ...
        {
            _ = new Matrix3();
            Matrix3 m3c = Matrix3.CreateRotation(9.62f);
        ...
        {
            _ = new Matrix4();
            Matrix4 m4c = Matrix4.CreateRotationZ(0.72f);
        ...
        {
            _ = new Matrix3();
            Matrix3 m3c = Transpose(Matrix3.CreateRotation(9.62f));
        ...
        {
            _ = new Matrix4();
            Matrix4 m4b = Transpose(Matrix4.CreateRotationY(-2.6f));
        ...
        {
            _ = new Matrix4();
            Matrix4 m4c = Transpose(Matrix4.CreateRotationZ(0.72f));
        ...
        {
            _ = new Matrix3();
            Matrix3 m3b = Matrix3.CreateTranslation(new Vector2(2, 3));
            _ = new Matrix3();
            Matrix3 m3c = Matrix3.CreateTranslation(new Vector2(3, 15));
        ...
        public void Vector4MatrixTranslation2()
        {
            // homogeneous point translation
            _ = new Matrix4();
            Matrix4 m4c = Transpose(Matrix4.CreateRotationZ(2.2f));
